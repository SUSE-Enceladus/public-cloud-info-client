...
class TestGetImagesVersionData(unittest.TestCase):
    ...
    def test_get_images_version_data(self, mock_form_url, mock_process):
        # Arrange
        mock_form_url.return_value = 'mocked_url'
        mock_process.return_value = 'mocked_response'
 
        # Act
        result = ifsrequest.get_images_version_data(
    ...
    @patch('lib.susepubliccloudinfoclient.infoserverrequests.__process')
    @patch('lib.susepubliccloudinfoclient.infoserverrequests.__form_url')
    def test_get_images_version_data_default_parameters(self, mock_form_url, mock_process):
        # Arrange
        mock_form_url.return_value = 'mocked_url'
        mock_process.return_value = 'mocked_response'
